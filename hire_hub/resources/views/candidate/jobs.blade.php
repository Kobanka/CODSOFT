...
<section class="container mx-auto py-12 md:px-5 bg-slate-100">
    <div class="mb-12">
        <h2 class="text-2xl font-bold text-ClearBlue text-center md:text-3xl">Applied jobs ({{ $listings->count() }})</h2>
    ...
    <div class="-my-6">
        ...
        @empty
            <p class="text-xl text-center text-gray-700">You Have Not Applied To A Job Yet !!!</p>
        @endforelse
    </div>
</section>
@endsection